  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="prose prose-gray max-w-none mt-6">
        ...
        <p>
          The ML model flagged <strong>4,183 providers</strong> at ≥80% confidence. Cross-validated performance: 83% precision, 66.6% recall. See the <Link href="/ml-fraud-detection" className="text-primary hover:underline">ML Fraud Detection page</Link> for full results and the complete list of flagged providers.
        </p>
