...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Nurse Practitioners: The Largest — and Most Flagged — Prescriber Group in Medicare',
    description: "Nurse Practitioners account for 19% of all Medicare Part D prescribers and 49% of all flagged providers. What's driving this disproportionate risk signal?",
    url: 'https://www.openprescriber.org/analysis/nurse-practitioners',
    type: 'article',
  },
    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="prose prose-gray max-w-none mt-6">
        ...
        <div className="not-prose grid grid-cols-2 md:grid-cols-4 gap-3 my-6">
          ...
          <div className="bg-red-50 rounded-xl p-4 text-center border border-red-200">
            <p className="text-xl font-bold text-red-700">{(np.avgOpioidRate ?? 0).toFixed(1)}%</p>
            ...
            <tbody className="divide-y">
              {[
                ...
                <tr key={s.specialty} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 text-right font-mono">{(s.avgOpioidRate ?? 0).toFixed(1)}%</td>
        ...
        <ol>
          ...
          <li><strong>Opioid rate of {(np.avgOpioidRate ?? 0).toFixed(1)}%</strong> — Nearly 3x higher than Internal Medicine ({(im.avgOpioidRate ?? 0).toFixed(1)}%) and Family Practice ({(fp.avgOpioidRate ?? 0).toFixed(1)}%). This is the single biggest driver of risk flags.</li>
