...
const categories: { heading: string; articles: { title: string; slug: string; desc: string; emoji: string }[] }[] = [
  {
    ...
    articles: [
      ...
      { title: 'The Controlled Substance Pipeline: Beyond Opioids', slug: 'controlled-substance-pipeline', desc: 'Benzodiazepines, stimulants, gabapentin — the broader controlled substance prescribing picture and multi-category risk.', emoji: '⚗️' },
      { title: 'How Telehealth Changed Prescribing Patterns', slug: 'telehealth-prescribing', desc: 'Remote prescribing of controlled substances, DEA waivers, and the risks of prescriber shopping via telehealth.', emoji: '📱' },
    ],
  },
  {
    ...
    articles: [
      ...
      { title: 'Pharmacy Benefit Managers: The Middlemen Problem', slug: 'pharmacy-benefit-managers', desc: 'How PBMs control drug pricing through spread pricing, rebate clawbacks, and formulary manipulation.', emoji: '🏢' },
