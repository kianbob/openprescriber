  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="prose prose-gray max-w-none mt-6">
        ...
        <p>
          The result: the model flags over 4,100 additional providers as high-risk based on behavioral similarity to the {excluded.length} known exclusions. These flagged providers are not accused of fraud — they are identified as statistically similar to providers who were. You can explore the full results on our <Link href="/high-risk" className="text-primary font-medium hover:underline">High Risk Providers</Link> page.
        </p>
        ...
        <div className="not-prose mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
          ...
          <p className="text-sm text-blue-800">Explore flagged providers: <Link href="/high-risk" className="text-primary font-medium hover:underline">High Risk Providers</Link></p>
        </div>
